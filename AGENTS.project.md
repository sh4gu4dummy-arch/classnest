...
- **Homes now:** 01–25 in catalog (teacher: 21–25 too still — **do not remake now**). **26–30 not READY** (twins + tableau). Next plan: `docs/home-round-31-35.md` — **travel/action bar**. Do not delete Home mp4s without a yes.
