...
export function ArtZoom({
  ...
  return (
    <div
      className="fixed inset-0 z-[120] flex items-center justify-center bg-bg/95 p-3 sm:p-6"
      style={{ top: "var(--grok-banner-h, 0px)" }}
      role="dialog"
      aria-modal="true"
...
export function EvolutionBurst({ data, onDone }: EvolutionBurstProps) {
  ...
  const overlay = (
    <div
      className="fixed inset-x-0 bottom-0 z-[200] flex items-center justify-center bg-ink/88 p-3 animate-in fade-in duration-200 sm:p-5"
      style={{ top: "var(--grok-banner-h, 0px)" }}
      role="dialog"
      aria-label={headline}
      onClick={() => {
