...
export function AppShell({
  ...
  return (
    <div className="min-h-[calc(100dvh-var(--grok-banner-h,0px))] text-fg">
      <header className="sticky top-[var(--grok-banner-h,0px)] z-40 border-b border-border/80 bg-surface/95 shadow-sm supports-[backdrop-filter]:bg-surface/85 supports-[backdrop-filter]:backdrop-blur-md">
          ...
          <div className="flex min-w-0 items-center gap-2 sm:gap-3">
            {backTo ? (
              ...
              <Link to="/" className="flex shrink-0 items-center gap-2 active:scale-95">
                <span className="flex size-8 items-center justify-center rounded-xl bg-gradient-to-br from-accent to-[#0f766e] text-accent-fg shadow-md sm:size-9 dark:to-[#134e4a]">
      ...
      <main
        className={cn(
          "mx-auto max-w-5xl px-3 py-4 sm:px-6 sm:py-6",
          className,
        )}
      >
